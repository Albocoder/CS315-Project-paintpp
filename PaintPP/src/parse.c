...
{
  "$end", "error", "$undefined", "DRAW", "$accept", "program", 0
};
#endif
  ...
  switch (yyn)
    {
        case 2:
#line 22 "parse.y"
    { cout << (yyvsp[(1) - (1)].stringedparams) << endl; }
    break;
...
static const char *const yytname[] =
{
  "$end", "error", "$undefined", "DRAW", "$accept", "program", YY_NULLPTR
};
#endif
...
#line 23 "parse.y" /* yacc.c:1646  */
    { cout << (yyvsp[0].stringedparams) << endl; }
